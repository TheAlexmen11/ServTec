...
public class FrmCliente extends javax.swing.JFrame {
    ...
    public FrmCliente() {
        ...
        clientes.cargarDatosCliente(tableModel);
    ...
    private void eliminarCliente() {
        ...
        if (filaseleccionado == -1 && filaseleccionado == 0) {
            ...
            if (mostrarConfirmacion("¿Estás seguro de eliminar cliente id : " + tcliente.getId_cliente() + "?", "Confirmar Eliminación")) {
                clientes.EliminarCliente(tcliente.getId_cliente());
            }
    ...
    private void modificarCliente() {
        ...
        if (filaseleccionado == -1) {
            ...
            if (!Tfrmclient.isVisible()) {
                Tfrmclient.setLocationRelativeTo(null);
                Tfrmclient.setVisible(true);
            }
            this.dispose();
        }
    ...
    private void tableClienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableClienteMousePressed
        ...
        if (fila == -1) {
            ...
            tcliente = clientes.ConsultarClienteporId(id);
